...
def get_wiki_explain(name):
    ...
    return {
        ...
        "image" : f"https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/{name}/{name}-original.svg"
    }
...
def build_param(name_original, FLAMEWORKDICT):
    ...
    param.update({
        "image" : f"https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/{name.lower()}/{name.lower()}-original.svg",
